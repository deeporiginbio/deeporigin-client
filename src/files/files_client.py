...
from .file_service.models.sync_file_schema_dto_credentials import SyncFileSchemaDtoCredentials
...
class FilesClient:
    ...
    def _parse_files_url(self, url: str) -> tuple[str, str]:
        ...
        if not match:
            raise ValueError(f"Invalid files URL: {url}. Expected format: files:///path")
    ...
    def check_health(self) -> bool:
        ...
        try:
            ...
            non_auth_client = Client(
                ...
                verify_ssl=self.client._verify_ssl
            )
